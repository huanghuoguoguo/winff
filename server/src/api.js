...
const { formatFileSize, getFileCategory, isPathSafe } = require('./utils');

/**
 * 创建文件列表 API 路由
 * @param {Object} sharedDirs - 共享根目录映射
 */
function createApiRouter(sharedDirs) {
    ...
    router.get('/files', (req, res) => {
        ...
        const { isRoot, targetDir, error } = require('./utils').resolveVirtualPath(sharedDirs, relativePath);
